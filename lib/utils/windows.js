...
module.exports = {
        ...
        return new Promise((resolve, reject) => {
            ...
            this.create(opts.ssid, opts.password)
                ...
                .then(NetworkAdaptors => {
                    ...
                    console.log('Configuring ICS to share:', this.ConnectedAdaptor);
                    return this.exec(util.format('"%s" enable "%s" "%s" true', path.join(__dirname, '../../', 'bin/win32/IcsManager.exe'), this.ConnectedAdaptor, hostedNetwork));
                })
                .then(() => {
    ...
    getNetworkAdaptors() {
        return new Promise((resolve, reject) => {
            this.exec('powershell "Get-NetAdapter | ft Name, Status, ifIndex, MacAddress, InterfaceDescription"')
                .then(output => {
