    ...
    enable(opts) {
        return new Promise((resolve, reject) => {
            ...
            this.create(opts.ssid, opts.password)
                .then(this.getInternetConnectedAdaptor.bind(this))
                .then(ConnectedAdaptor => {
                    this.ConnectedAdaptor = ConnectedAdaptor;
                })
                .then(() => {
                ...
                .then(NetworkAdaptors => {
                    ...
                    return this.exec(util.format('"bin/win32/IcsManager.exe" enable "%s" "%s" true', this.ConnectedAdaptor.InterfaceAlias, hostedNetwork));
                })
                .then(resolve)
                .catch(reject);
        });
